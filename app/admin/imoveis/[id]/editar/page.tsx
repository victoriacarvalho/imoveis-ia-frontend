...
export default function EditarImovelPage() {
  ...
  useEffect(() => {
    async function init() {
      ...
      try {
        const adminRes = await fetch(`${API_URL}/admin/me?userId=${userId}`);
        ...
        const propertyRes = await fetch(
          `${API_URL}/admin/properties/${params.id}?userId=${userId}`,
        );
        ...
        setFormData({
          ...
          parkingSpots: String(property.parkingSpots ?? 0),
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/admin/properties/${params.id}`, {
        method: "PUT",
        headers: {
  ...
  if (!isLoaded || loading || isAdmin === null) {
    return (
        ...
        <form
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="inline-flex items-center justify-center rounded-full bg-gray-900 px-5 py-3 text-sm font-bold text-white">
          ...
          {formData.mainImage && (
            <div>
              ...
              <img
                ...
                alt="Prévia"
                className="w-full h-64 object-cover rounded-3xl border border-gray-100 bg-gray-50"
              />
            </div>
          )}
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              disabled={saving}
              className="inline-flex items-center justify-center rounded-full bg-teal-500 px-6 py-3 text-sm font-bold text-white hover:bg-teal-600 transition disabled:opacity-60">
              {saving ? (
                <>
